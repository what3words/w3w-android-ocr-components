...
public class BitmapUtils {
    ...
    @Nullable
    public static Bitmap getBitmap(ByteBuffer data, FrameMetadata metadata, Rect crop) {
        data.rewind();
        ...
        try {
            ...
            stream.close();
            return rotateAndCropBitmap(bmp, metadata.getRotation(), false, false, crop);
        } catch (Exception e) {
    ...
    private static Bitmap rotateAndCropBitmap(
        ...
        Bitmap rotatedBitmap =
                Bitmap.createBitmap(bitmap, crop.left, crop.top, crop.width(), crop.height(), matrix, true);
    ...
    @Nullable
    public static Bitmap getBitmapFromContentUri(ContentResolver contentResolver, Uri imageUri, Rect crop)
            throws IOException {
        ...
        return rotateAndCropBitmap(decodedBitmap, rotationDegrees, flipX, flipY, crop);
    }
